...
W1_t = torch.tensor(net.W1, requires_grad=True)
b1_t = torch.tensor(net.b1, requires_grad=True)
W2_t = torch.tensor(net.W2, requires_grad=True)
b2_t = torch.tensor(net.b2, requires_grad=True)
